...
h('use', {x:'2', y:'0', xlinkHref, className:piece.move(i, getI([x+1, y-1]), board) ? null : 'off'}),
h('use', {x:'0', y:'2', xlinkHref, className:piece.move(i, getI([x-1, y+1]), board) ? null : 'off'}),
h('use', {x:'2', y:'2', xlinkHref, className:piece.move(i, getI([x+1, y+1]), board) ? null : 'off'}),
piece.goal && h('use', {xlinkHref:'#ferzFnGoal', transform:'translate(1.5 1.5) scale(.5)'}),
)
}
